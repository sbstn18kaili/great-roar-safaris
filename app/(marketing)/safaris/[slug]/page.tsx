...
export default async function SafariDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  if (!safari) notFound();
  const itinerary = itineraries[slug] ?? ["Day 1: Arrival and safari briefing.", "Day 2: Full-day game drive in prime wildlife zones.", "Day 3: Scenic transfer and immersive safari activities.", "Final Day: Return transfer and departure."];
