  ...
  return (
    <section className="bg-sand py-24">
      <div className="container-luxury">
        <SectionHeading eyebrow="Wildlife calendar" title="Plan around nature’s rhythm" description="Month-by-month wildlife highlights to align your travel dates with the best safari moments." />
